...
export default function ClickHintText() {
  ...
  return (
    <motion.mark
      ...
      className="relative -right-20 -top-24 flex rotate-[20deg] items-center gap-0.5 bg-highlight font-hand text-muted sm:-right-[200px] sm:-top-[96px] h-xs:-right-8 w-xs:top-44 w-xs:-rotate-0"
    >
